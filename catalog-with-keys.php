        ...
        <?php foreach($products as $products): ?>
            <div class="col-md-4">
                <div class ="card h-100">
                    ...
                    <div class="card-body">
                        <h5 class="card-title"><?= htmlspecialchars($products["name"]) ?></h5>
                        <p class="card-text">Prix: <?= htmlspecialchars($products["price"]) ?></p>
                        <p class="card-text">Poids: <?= htmlspecialchars($products["weight"]) ?></p>
                        <p class="card-text">Montant Tva: <?= htmlspecialchars($products["tva"]) ?></p>
                        <p class="card-text">Montant TTC: <?= htmlspecialchars($products["ttc"]) ?></p>
                        <?php
                        if($products["discount"]!=null): ?>
                            <p class="card-text">Montant remisé: <?= htmlspecialchars($products["promo_price"]) ?></p>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
